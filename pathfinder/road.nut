...
/**
 * A RoadPathFinder_private Pathfinder.
...
class RoadPathFinder_private.Cost
{
    _main = null;
...
function RoadPathFinder_private::FindPath(iterations)
{
...
function RoadPathFinder_private::_GetBridgeNumSlopes(end_a, end_b)
{
    local slopes = 0;
...
function RoadPathFinder_private::_Cost(self, path, new_tile, new_direction)
{
...
function RoadPathFinder_private::_Estimate(self, cur_tile, cur_direction, goal_tiles)
{
...
function RoadPathFinder_private::_Neighbours(self, path, cur_node)
{
...
function RoadPathFinder_private::_CheckDirection(self, tile, existing_direction, new_direction)
{
    return false;
}

function RoadPathFinder_private::_GetDirection(from, to, is_bridge)
{
 ...
 */
function RoadPathFinder_private::_GetTunnelsBridges(last_node, cur_node, bridge_dir)
{
...
function RoadPathFinder_private::_IsSlopedRoad(start, middle, end)
{
...
function RoadPathFinder_private::_CheckTunnelBridge(current_tile, new_tile)
{
